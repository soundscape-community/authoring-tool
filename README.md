...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/soundscape-community/authoring-tool?quickstart=1)
...
3. Choose the "Run and Debug" tab on the left-hand side of the screen (Ctrl+Shift+D), and select "run full stack" from the dropdown menu.
